...
class GraphService:
    ...
    def init_tools(self):
        def init_retriever_tool():
            ...
            vector_store = PineconeVectorStore.from_existing_index(index_name=os.environ['PINECONE_INDEX'],
    ...
    def init_nodes_and_edges(self):
        ...
        def generate_node(state):
            ...
            prompt = "You are an assistant for question-answering tasks about amazon web service. \
